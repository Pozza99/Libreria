...
using Dottor.MyBookLibrary.Web.Data;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Hosting;
using Dottor.MyBookLibrary.Data;
using Dottor.MyBookLibrary.Data.Repositories;
...
namespace Dottor.MyBookLibrary.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ISBook, SBookController>();
            services.AddScoped<IBooksRepository, BooksRepository>();
            services.AddScoped<IBookReadHistoriesRepository, BookReadHistoriesRepository>();
            services.AddScoped<IBooksGenres, BooksGenresRepo>();
